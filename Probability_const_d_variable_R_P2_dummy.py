...
# -*- coding: utf-8 -*-
"""
Created on Sat Jan 18 16:41:34 2020
...
path = '/Users/sebas/morpheus/Example-CellSorting-2D_sweep_34/'
...
iterations = sweep_data['P2'].iloc[-1] # +1 comes from iterations zero
# Save array with scanned distances:
distances = sweep_data['P1'].unique()
